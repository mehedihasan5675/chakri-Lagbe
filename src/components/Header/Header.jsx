...
const Header = () => {
    ...
    return (
        <nav className='grid bg-gray-100 py-2 items-center grid-cols-3    main_container'>
            <div className=''><h1 className=' font-bold text-xl md:text-2xl tracking-wider text-indigo-800'><span className='text-indigo-600 text-left'>Chakri</span>Lagbe?</h1></div>
            <div className={`absolute px-4 md:px-0 md:py-0 py-3 bg-gray-100 w-full duration-700 md:static ${open ? 'top-12 left-0':'top-12 -left-[800px]'}`}>
            ...
            <div className='text-end '>
                <Link>
                <button className='bg-gradient-to-r from-indigo-400  to-purple-500 px-3 md:px-4 py-2 md:py-3 text-white rounded-md font-medium tracking-wider'>Star Applying</button>
                </Link>
            </div>
        </nav>
    );
